...
import rosbag
import h5py
from rapprentice import bag_proc_old
import yaml
...
if args.clouds_only:
    ...
    for (i_bag, bag_info) in enumerate(bag_infos):
        ...
        bag_proc_old.add_bag_to_hdf(bag, annotations, hdf, demo_name)
        bag_proc_old.add_rgbd_to_hdf(osp.join(task_dir, video_dir), annotations, hdf, demo_name)
